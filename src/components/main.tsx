...
const Main = () => {
    return(
        <div className="flex justify-center items-center">
                ...
                <img 
                src="https://i.ytimg.com/vi/3Pocj2hZRx0/hq720.jpg?sqp=-oaymwE7CK4FEIIDSFryq4qpAy0IARUAAAAAGAElAADIQj0AgKJD8AEB-AH-CYAC0AWKAgwIABABGH8gOihMMA8=&rs=AOn4CLD1FzWuqf7HS72OEKsYOeOvfMjBAw" 
                alt="img"
